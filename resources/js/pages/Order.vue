<template>
    <layout>
        ...
        <Progress :stepIndex="step" :steps="steps"></Progress>
        ...
        <section class="bg-grey-lightest -mt-2">
            <div class="mx-auto flex flex-wrap pb-12 justify-center">

                <h1 class="w-full mb-2 text-5xl font-bold leading-tight text-center text-grey-darkest">{{ stepName }}</h1>
